 ...
 * 这是LWFactoryIndicatorBak-大工业电表指针记录备份表的数据传输对象基类<br>
 */
public class LwFactoryIndicatorBakDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的LwFactoryIndicatorBakDtoBase对象
     */
    public LwFactoryIndicatorBakDtoBase(){
    }
