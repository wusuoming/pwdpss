 ...
 * 这是LWNewFactoryIndicatorBak-大工业新电表指针备份表的数据传输对象基类<br>
 */
public class LwNewFactoryIndicatorBakDtoBase implements Serializable{
     ...
     */
    public LwNewFactoryIndicatorBakDtoBase(){
    }
