 ...
 * 这是LWWholeSaleIndicator-趸售电表指针记录表的数据传输对象基类<br>
 */
public class LwWholeSaleIndicatorDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的LwWholeSaleIndicatorDtoBase对象
     */
    public LwWholeSaleIndicatorDtoBase(){
    }
    ...
    /**
     * 设置属性退无功电量
     * @param unCompensateQuantity 待设置的属性退无功电量的值
     */
    ...
    /**
     * 设置属性退有功电量
     * @param compensateQuantity 待设置的属性退有功电量的值
     */
