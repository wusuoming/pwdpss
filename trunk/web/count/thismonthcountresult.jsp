...
<form  name="fm" method="post">
	...
	<tr>
			<td class=title0 colspan="13"><font size="4">包头市农电公司电费电量发行单（当月）</font></td>
		</tr>
		<tr>
		<td nowrap colspan="2">
	...
	<tr >
				...
				<td nowrap width="10%"  align="center">
					<span class="title"><font size="2"><%=PowerFeeCal.getValue((lwCorporationSummaryDto.getSanXiaFee()- lwCorporationSummaryDto.getSanXiaFee()/1.17),AppConst.TWO_DOT_FLAG)%></font></span>
				<br></td>
				<td nowrap width="10%"  align="center">
					<span class="title"><font size="2"><%=PowerFeeCal.getValue((lwCorporationSummaryDto.getPowerFee()-lwCorporationSummaryDto.getPowerFee()/1.17),AppConst.TWO_DOT_FLAG)%></font></span>
				<br></td>
				<td nowrap width="10%"  align="center">
					<span class="title"><font size="2"><%=PowerFeeCal.getValue((lwCorporationSummaryDto.getSurcharge()-lwCorporationSummaryDto.getSurcharge()/1.17),AppConst.TWO_DOT_FLAG)%></font></span>
				<br></td>
			...
			<tr >
				...
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=Math.round(sumfpower)%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(sumfc)%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format( sumfsanxia)%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format( summfdianjin)%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format( sumfjijin)%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format( sumftax)%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format( sumfsanxiatax)%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format( sumfdianjintax)%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format( sumfjijintax)%></font></span>
				<br></td>
				...
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format( sumffee)%></font></span>
				<br></td>
		...
		<tr >
				...
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=Math.round( sumfpower + Double.parseDouble(sumwpower) + sumtownSataDto.getSumPower())%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(Double.parseDouble(sumwc) + sumfc + sumtownSataDto.getPurePowerFee())%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
				...
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(Double.parseDouble(summwdianjin) + summfdianjin
					+ sumtownSataDto.getPureDianJin())%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(Double.parseDouble(sumwjijin) + sumfjijin + sumtownSataDto.getPureJiJin())%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(Double.parseDouble(sumwtax) + sumftax + sumtownSataDto.getPowerFeeTax())%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(Double.parseDouble(sumwsanxiatax)+ sumfsanxiatax
					+ sumtownSataDto.getSanXiaTax())%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(Double.parseDouble(sumwdianjintax) + sumfdianjintax
					+ sumtownSataDto.getDianJinTax())%></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(Double.parseDouble(sumwjijintax) + sumfjijintax
				...
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(Double.parseDouble(sumwfee) + sumffee + sumtownSataDto.getSumPowerFee())%></font></span>
				<br></td>
