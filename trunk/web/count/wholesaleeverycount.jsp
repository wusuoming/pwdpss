		...
		<table class=common width="500%" border="1" cellspacing="0"
			...
			<tr>
				<td class=title0 colspan="14">
					<font size="4">包头市农电公司趸售电费电量发行单（当月）</font>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td nowrap width="10%" align="center" rowspan="5">
					<span class="title"><font size="2">土右供电局</font>
					</span>
					<input type="hidden" name="comCode" value="ty">
					<input type="hidden" name="comName" value="土右供电局">
					<br>
				</td>
			...
			<tr>
				<td nowrap width="10%" align="center" rowspan="5">
					<span class="title"><font size="2">达茂供电局</font>
					</span>
					<input type="hidden" name="comCode" value="dm">
					<input type="hidden" name="comName" value="达茂供电局">
					<br>
				</td>
				<td nowrap width="10%" align="center">
			...
			<tr>
				<td nowrap width="10%" align="center" rowspan="5">
					<span class="title"><font size="2">九原供电局</font>
					</span>
					<input type="hidden" name="comCode" value="jy">
					<input type="hidden" name="comName" value="九原供电局">
					<br>
				</td>
				<td nowrap width="10%" align="center">
			...
			<tr>
				<td nowrap width="10%" align="center" rowspan="5">
					<span class="title"><font size="2">固阳供电局</font>
					</span>
					<input type="hidden" name="comCode" value="gy">
<input type="hidden" name="comName" value="固阳供电局">
					<br>
				</td>
				<td nowrap width="10%" align="center">
			...
			<tr>
				<td nowrap width="10%" align="center" rowspan="5">
					...
					<input type="hidden" name="comName" value="总计">
					</span>
					<br>
				</td>
				<td nowrap width="10%" align="center">
