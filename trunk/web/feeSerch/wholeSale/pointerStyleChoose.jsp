...
<%
	String code=request.getParameter("UserNo");
 ...
 %>
          <tr>
           ...
           <td class="input"><a href="/iacontact/UIFinalBookAction.do?userno=<%=code%>&&date=<%=alldate%>"><font>有功</font></a></td>
			  <td class="input"><a href="/iacontact/UIFinalBookTwoAction.do?userno=<%=code%>&&date=<%=alldate%>"><font>无功</font></a></td>
		 <td class=input style="display: none"><input  name="linecode" type="text" value="<%=code%>"></td>
		  <td class=input style="display: none"><input  name="date" type="text" value="<%=alldate%>"></td>
