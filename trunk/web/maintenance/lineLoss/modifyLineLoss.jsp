      ...
      <form name="fm" method="post">
        <table id="table_userMain" width="1050" border="0">
         <tr class=listtitle align="center">
			<td class=title0 colspan="10"><B>修改线损信息</B></td>
		</tr>
		<%
		 ...
		 %>
          <tr>
            ...
            <td class=input><%=lineLossDto.getLineCode()%><input type="hidden" name="LineCode" value="<%=lineLossDto.getLineCode()%>" type="text" class="text"></td>
           <td class=title>线路电阻值</td>
            <td class=input><input name="R" type="text" value="<%=lineLossDto.getR()%>" class="text"></td>
         <td class=title>线路长度（KM）</td>
            <td class=input><input name="lineLong" type="text" class="text" value="<%=lineLossDto.getLineLong()%>"></td>
          </tr>
		  <tr>
		    
		  <td class=title>额定电压（KV）</td>
            <td class=input><input name="volt" type="text" value="<%=lineLossDto.getVolt()%>" class="text"></td>
            
          <td class=title>用电时间（小时）</td>
            <td class=input><input name="t" type="text"  class="text" value="<%=lineLossDto.getT()%>"></td>
            <td class=input>
            <td class=input>
       </tr>
        </table>
