      ...
      <form name="fm" style="display:block;">
         ...
         <tr class=listtitle align="center">
          ...
          <tr>
            ...
            <td class=input><input name="PT" type="text"  class="text" ></td>
          </tr>
		  <tr>
		  ...
		  <tr>
		  	...
		  	<td class=input><input name="PTRate" type="textfiled" class="text" ><span class="warning">*</span></td>
...
function addPowerUser(){
  ...
  fm.action="/iacontact/addLWPT.do";
 fm.submit();
