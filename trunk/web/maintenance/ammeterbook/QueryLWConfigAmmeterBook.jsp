...
<body class=interface>
    ...
    <!--CONTENT BEGIN-->
      ...
      <form name="fm" style="display:block;">
        ...
        <tr class=listtitle align="center">
			<td class=title0 colspan="7"><B>表本配置管理信息</B></td>
		</tr>
	...
	<form name="fm1" >
		...
		<tr class=listtitle>
			...
			<td nowrap ><span class="title">用户数</span></td>
        ...
        {          
            ...
            if(fm.checkboxSelect.checked==true){
                         ...
                         //   alert('checkboxSelect:'+checkboxSelect);
                          ...
                          this.location = "<%=request.getContextPath()%>/updateBook.do?123=1";
     ...
     function configBook()
        {          
            ...
            if(fm.checkboxSelect.checked==true){
                           ...
                           this.location = "<%=request.getContextPath()%>/configBook.do?";
       ...
       //     alert('count:'+count);
            ...
            if(fm.checkboxSelect.checked==true){
						...
						if(!confirm('确认要删除？将不可恢复。')){
                            ...
                            this.location = "<%=request.getContextPath()%>/deleteBook.do?";
