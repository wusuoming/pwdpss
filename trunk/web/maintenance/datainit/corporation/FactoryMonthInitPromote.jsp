 ...
 function validateUserQueryForm(form)
{
  ...
  function AddForm(){
       var strURL = "<%=request.getContextPath()%>/factorymonthinit.do?type=factory";
...
<form  name="fm" method="post"
	...
	<tr class=listtitle align="center">
		...
		<tr class=listtitle align="center">
			<td class=title0 colspan="4"><B><font size="3">大工业月数据初始化页面</font></B></td>
		</tr>
		<br>
		
		<tr>
			<td class="blue" >说明：</td><td >大工业表指针初始化是为系统上线时，需要录入各个用电用户上月指针而开发的功能。请您选择本月结帐日期，作为月底的结帐日，然后点击
			初始化按钮，即可列出全部用户的列表，输入各个用户的上月指针数即可。</td>
		</tr>
		<%--<tr>
			<td class="blue" colspan="1">本月结算日期</td><td><input name="statMonth" type="text" class="text" width="20" id="f_date_shqqs"  size="31" onkeyPress="return pressFullDate(event)"   onblur="checkFullDate(this);" readonly="readonly"></td>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		...
		<tr class="listtitle" align="center">			
			<td class=button align="center"><input type=button class=button
				...
				<td style="display: none"><input class="text" name="type" type="text"  value="factory">
		</tr>
	</table>
	</td>
<td>
