...
<body id="all_title">
    ...
    <!--CONTENT BEGIN-->
      ...
      <form name="fm" method="post">
		...
		LwCoporationUserInfoDto lwCoporationUserInfoDto=(LwCoporationUserInfoDto)request.getAttribute("lwCoporationUserInfoDto");
		 ...
		 %>
          <tr>
            ...
            <td class=input><input name="UserName" type="text" class="text" value="<%=lwCoporationUserInfoDto.getUserName()%>">&nbsp;<img
							src="../../iacontact/images/redstar.gif" ></td>			
          </tr>
		  <tr>
		  <td class=title>地址</td>
            <td class=input><input name="Address" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getAddress()%>"></td>
			  <td class=title>开户行</td>
            <td class=input><input name="accountBank" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getAccountBank()%>"/>
            ...
            <td class=input><input name="taxNo" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getTaxNo()%>"></td>
			  <td class=title>银行帐号</td>
            <td class=input><input name="accountNo" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getAccountNo()%>"/>
				</tr>  
		  ...
		  <tr>
            ...
            <td class=input><select name="voltage"  class="input">
            ...
            <td class=input><input name="lineCode" type="text" value="<%=lwCoporationUserInfoDto.getLineNo()%>" 
							 ></td> 
				</tr>  
				<tr>
		<td class=title>容量/需量</td>
          
            <td class=input><select name="industryType"  class="input" onchange="corn()">
            ...
            <td class=input id="c2" style="display: "><input name="rongliangPower" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getRongliangPower()%>"></td>
           <td class=title id="n1" style="display:none ">需量表倍率</td>
            <td class=input id="n2" style="display:none "><input name="xuliangRate" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getNeedRate()%>"></td>
            
           
		  </tr>
		 <tr>
		  	<td class=title >生产时的电价</td>
		  	<td class="input" ><select name="shengChanpriceStyle"  class="input" >
        ...
        <td class="input" ><select name="shengChanKV"  class="input" >
...
<tr>
       <td class=title >停产时的电价</td>
		  	<td class="input" ><select name="tingChanpriceStyle"  class="input" >
       ...
       <td class="input" ><select name="tingChanKV"  class="input" >
		...
		<tr>
		  	...
		  	<td class=input><input name="tingChanRongliangPrice" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getTingChanrongLiangPrice() %>"></td>
		  	<td class=title >生产容量电价</td>
		  	<td class=input><input name="shengChanRongliangPrice" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getShengChanrongLiangPrice() %>"></td>
		  </tr>
		  <tr>
		  	<td class=title >生产时电金电价</td>
		  	<td class=input><input name="tingChanDianJinPrice" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getTingChandianJinPrice() %>"></td>
		  	<td class=title >停产时电金电价</td>
		  	<td class=input><input name="shengChanDianJinPrice" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getShengChandianJinPrice() %>"></td>
		  </tr>
		  
		 
		  <tr>
		  	<td class=title >照明电量方式</td>
		  	<td class="input" ><select name="pepoleFlag"  class="input" onchange="borc()">
       ...
       <td class=title id="a1" style="display: none">电量</td>
		  	<td class=input id="a2"  style="display: none"><input name="pepolePower" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getPepolePower()%>"></td>
		  	<td class="input" id="b1" style="display: ">
		  	<td class="input" id="b2" style="display: ">
		  </tr>
		  <tr>
		  	 <td class=title >线损比例</td>
		  	<td class=input><input name="lineLossScale" type="text"  class="text" value="<%=lwCoporationUserInfoDto.getLineLossScale()%>">%</td>
		  <td class=title >电金电量</td>
		  	<td class="input" ><select name="dianJinPower"  class="input" >
...
<!--一大堆的按钮-->
    ...
    <table width="50%" border="0" cellspacing="0" cellpadding="0" align="center">  
      <tr>
        <td class=button><input name="add" type="button" class=button value=" 保 存 " onClick="javascript:editCorporationUser();"></td><%--
