				...
				<table table class=common width="100%" cellspacing="1"
					...
					<tr>
						...
						<td class="input" nowrap colspan="1">
							<input  name="UserName"
								value="<%=subjoinFeeDto.getName()%>">
						</td>
						<td class="input" nowrap colspan="1">
							<input  name="nongwanhuandai"
								value="<%=subjoinFeeDto.getNongwanghuanDai()%>">
						</td>
				
		
						<td class="input" nowrap colspan="1">
							<input  name="sanxia"
								value="<%=subjoinFeeDto.getSanXia()%>">
						</td>
						<td class="input" nowrap colspan="1">
							<input  name="kuquyimin"
								value="<%=subjoinFeeDto.getKuquyimin()%>">
						</td>
						<td class="input" nowrap colspan="1">
							<input name="kezaisheng"
								value="<%=subjoinFeeDto.getKezaishengnengyuan()%>">
						</td>
...
function serchWholeSale(){
	...
	fm.action="/iacontact/savesijin.do";
	fm.submit();
}
</script>
