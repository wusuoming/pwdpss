    ...
    %>
         ...
         <tr class=listtitle align="center">
          ...
          <tr>
            ...
            <td class=input><input name="userName" type="text" class="text"  style="width:120px" value="<%=lwPowerUserDto.getUserName()%>" ></td>
          </tr>
		  <tr>
		  <td class=title >地址</td>
            <td class=input><input name="address" type="text"  value="<%=lwPowerUserDto.getAddress()%>" class="text"></td>
 ...
 <% Collection salePriceList = blLwDcodeFacade.findByConditions(" codetype = 'SaleLevel'"); 
   ...
   <tr class=listtitle align="center">
	...
	<%LwAmmeterChangeDto ammeter = (LwAmmeterChangeDto)request.getAttribute("lwAmmeterChangeDto"); %>
		...
		<tr>
			<td class="title"  align="center"><input name="people" type="text" class="text" width="20" value=<%=lwProrateDto.getResident() %>></td>
			<td class="title"  align="center"><input name="notPeople" type="text" class="text" width="20" value=<%=lwProrateDto.getIndecisive() %>></td>
			<td class="title"  align="center"><input name="farm" type="text" class="text" width="20" value=<%=lwProrateDto.getAgricultural()%>></td>
			<td class="title"  align="center"><input name="produce" type="text" class="text" width="20" value=<%=lwProrateDto.getProduce() %>></td>		
			<td class="title"  align="center"><input name="business" type="text" class="text" width="20" value=<%=lwProrateDto.getBusiness() %>></td>
			<td class="title"  align="center"><input name="notFactory" type="text" class="text" width="20" value=<%=lwProrateDto.getIndustry() %>></td>
...
<!--一大堆的按钮-->
  <div class="box_frame">
    <table width="50%" border="0" cellspacing="0" cellpadding="0" align="center">  
      <tr>
        <td class=button><input name="add" type="button" class=button value="修 改 " onClick="javascript:updatePowerUser();"></td>
