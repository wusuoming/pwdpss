		...
		<%
		 ...
		 %>
          <tr>
            ...
            <td class=input ><%=transforDto.getTransforName()%><input type="hidden" name="transforName" type="text" class="text" value="<%=transforDto.getTransforName()%>"></td>
           <td class=title>电话</td>
            <td class=input><input name="phone" type="text" class="text" value="<%=transforDto.getPhone()%>"></td>
          <td class=title>变压器空载损耗(KW)</td>
            <td class=input><input name="kongzaiLoss" type="text" class="text" value="<%=transforDto.getKongzaiLoss()%>"></td>
          </tr>
		  <tr>
		    
		  <td class=title>短路阻抗(KW)</td>
            <td class=input><input name="duanluLoss" type="text" class="text" value="<%=transforDto.getDuanluLoss()%>"></td>
            
          <td class=title>额定容量(KV)</td>
            <td class=input><input name="contentPower" type="text"  class="text" value="<%=transforDto.getContentPower()%>"></td>
            <td class=title>用电时间(小时)</td>
            <td class=input><input name="useHour" type="text"  class="text" value="<%=transforDto.getUseHour()%>"></td>
       </tr>
        <tr>
       		<td class=title>空载电流</td>
            <td class=input><input name="kongzaiCT" type="text"  class="text" value="<%=transforDto.getKongzaiCT()%>"></td>
            <td class=title>短路电压</td>
            <td class=input><input name="duanluPT" type="text"  class="text" value="<%=transforDto.getDuanluPT()%>"></td>
       <td class=title>连续供电时间(小时)</td>
            <td class=input><input name="suplyHour" type="text"  class="text" value="<%=transforDto.getSuplyHour()%>"></td>
...
function addTransfor(){
 ...
 fm.action="/iacontact/editTransfor.do";
