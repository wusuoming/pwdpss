    ...
    <!--CONTENT BEGIN-->
      ...
      <form name="fm" >
		...
		LwWholeSaleUserInfoDto lwWholeSaleUserInfoDto=(LwWholeSaleUserInfoDto)request.getAttribute("lwWholeSaleUserInfoDto");
		 %>
          <tr>
            ...
            <td class=input style="display: none"><input name="transformerName" readOnly=true type="hidden" class="text" value="<%=lwWholeSaleUserInfoDto.getUserNo()%>"></td>
            <td class=title>供电电压</td>
           
             <td class=input><select name="voltage" disabled>
		  ...
		  <tr>
		    <td class=title>所属农电局</td>
			  <td class=input><select name="company" disabled>
		  ...
		  <td class=title>趸售类型</td>
            ...
            <td class=input><select name="wholeSaleType" onchange="isHaveProrate()" disabled>
       ...
       <tr>
            ...
            <td class=input><input name="phoneNo" readOnly=true type="text"  class="text" value="<%=lwWholeSaleUserInfoDto.getPhoneNo()%>"></td>

           <td class=title>电话</td>
            <td class=input><input name="lineCode" readOnly=true value="<%=lwWholeSaleUserInfoDto.getLineCode()%>" type="text"  class="text"></td>
       </tr>
        <tr>
       		<td class=title>是否为考核表</td>
           
             <td class=input><select name="ifCal" disabled>
