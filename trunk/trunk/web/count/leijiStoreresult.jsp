...
<form  name="fm" method="post">
	...
	<td style="display:none"><input type="hidden" name="StartMonth" value="<%=s%>"></td>
		...
		%>
			<tr >
				<td nowrap width="10%"  align="center">
					<span class="title"><font size="2"><%=faxingDto.getUserName() %></font></span>
				
				<br></td>
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=Math.round(faxingDto.getQuantity()) %></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
				...
				<br></td>	
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(faxingDto.getChaBieFee())  %></font></span>
				<br></td>	
				<td nowrap width="10%" align="center">
					<span class="title"><font size="2"><%=df.format(faxingDto.getChaBieTax())  %></font></span>
				<br></td>
				<td nowrap width="10%" align="center">
...
strURL = "<%=request.getContextPath()%>/UIThisMonthAllCountAction.do?inputDate="+b+"&counttype="+counttype+"&print=1";
