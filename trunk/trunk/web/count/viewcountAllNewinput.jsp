      ...
      <form name="fm" method="post">
        ...
        <tr class=listtitle align="center">
         ...
         <td align="center"  style="display: " id='jianren'>录入年月：				
		  ...
		  <tr class="listtitle" align="center"><td class=button align="center"><input class=button name="serch" type="button"  value=" 统计 " onClick="javascript:corporationFeeCount();"></td>
...
fm.action="/iacontact/UIViewCountNewResultAction.do";
fm.submit();
}	
if(fm.counttype.value=='2'){

fm.action="/iacontact/UICountAllNewLjAction.do";
fm.submit();
}	
}
Calendar.setup({
