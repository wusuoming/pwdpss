...
%>
  ...
  <tr class=listtitle align="center">
			<td class=title0 colspan="11"><B>大用户<%=corporation.getStatMonth()%>结算单</B></td>
		</tr>
    ...
    <tr>
     ...
     <tr>
           ...
           <td nowrap><span class="title">三峡基金</span></td>
			...
			<td nowrap colspan="2"><span class="title"><%=corporation.getSurcharge()%></span></td>
    </tr>
    <tr>
    ...
    <tr>
           ...
           <td nowrap colspan="2"><span class="title"><input name="exends1" value=""  style="width:65px"></span></td>
			<td nowrap colspan="2"><span class="title"><input name="exends2" value=""  style="width:65px"></span></td>
			<td nowrap><span class="title"><input name="exends3" value=""  style="width:65px"></span></td>
			<td nowrap colspan="2"><span class="title"><input name="exends4" value=""  style="width:65px"></span></td>
			<td nowrap colspan="2"><span class="title"><input name="exends5" value=""  style="width:65px"></span></td>
			<td nowrap colspan="2"><span class="title"><input name="exends6" value=""  style="width:65px"></span></td>
			
    </tr>
    <tr>
   
           <td nowrap colspan="2"><span class="title"><input name="exends7" value=""  style="width:65px"></span></td>
			<td nowrap colspan="2"><span class="title"><input name="exends8" value=""  style="width:65px"></span></td>
			<td nowrap ><span class="title"><input name="exends9" value=""  style="width:65px"></span></td>
			<td nowrap colspan="2"><span class="title"><input name="exends10" value=""  style="width:65px"></span></td>
			<td nowrap colspan="2"><span class="title"><input name="exends11" value=""  style="width:65px"></span></td>
			<td nowrap colspan="2"><span class="title"><input name="exends12" value=""  style="width:65px"></span></td>
