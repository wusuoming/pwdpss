...
BODY {
    ...
    <tr>
    			...
    			<tr>
					...
					<td nowrap>
						<span class="title"><input name="Power10" value="<%=Math.round(Double.parseDouble(sum10Power)) %>"style="width:65px"></span>
					</td>
					<td nowrap>
						<span class="title"><input name="ss" value=""
								style="width: 65px"></span>
					...
					<td nowrap>
						<span class="title"><input name="Power35" value="<%=Math.round(Double.parseDouble(sum35power)) %>"style="width:65px"></span>
					</td>
					<td nowrap>
						<span class="title"><input name="ss" value=""
								style="width: 65px"></span>
           ...
           <td nowrap colspan="2"><span class="title">可再生能源</span></td>
			...
			<td nowrap colspan="2"><span class="title"><input name="chabiedianfei" value="<%=differenceQuantityFee%>"  style="width:65px"></td>
				...
				<tr>
					...
					<td nowrap colspan="2">
						<span class="title"><input name="exends8" value="0"
								style="width: 65px"> </span>
					</td>
					<td nowrap colspan="2">
  ...
  {   
   ...
   var Power10 = fm.Power10.value;
   var Power35 = fm.Power35.value;
   
    var chabiedianfei = fm.chabiedianfei.value;
