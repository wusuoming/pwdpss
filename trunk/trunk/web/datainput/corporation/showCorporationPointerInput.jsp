...
<body class=interface>
    ...
    <!--CONTENT BEGIN-->
      ...
      <table class=common width="100%" cellspacing="1" cellpadding="4">
        <%
       List list=(List)request.getAttribute("allPointer");
	 ...
	 %>
          ...
          <tr>
           <td class="title">月中停产或生产</td>				
				<td class="input" ><select name="stopProduce"  class="text">
	 ...
	 %> 
      <tr class=listtitle>
					...
					<tr >
						...
						<td class="input" ><input name="LastWorkNum" value="<%=lwNewFactoryIndicatorDto.getLastWorkNum()%>" onblur="checkWork()" style="border:0"  style="width:65px"></td>
							...
							<%
							 ...
							 %>
							  <td class="input" ><input name="ThisWorkNum" value="<%=lwNewFactoryIndicatorDto.getChangeWorkPointer()%>" onblur="checkWork()" style="width:65px"></td>
							 <%}else{ %>
						...
						<%
								if(lwNewFactoryIndicatorDto.getAmmeterStyle().equals("0")&&lwNewFactoryIndicatorDto.getIfChange().equals("1")){
							 %>
							<td class="input" ><input name="ThisIdleNum" value="<%=lwNewFactoryIndicatorDto.getChangeunWorkPointer()%>" onblur="checkunWork()" style="width:65px"></td>
							 <%}else{ %>
        ...
        <td class="input" ><select name="state" style="width:60px">
			...
			<td nowrap><span class="title">无功电量  </span></td>
					...
					<tr >
						...
						<td class="input" ><input name="changeLastWorkNum" value="<%=LwNewFactoryIndicatorDto2.getChangeWorkPointer()%>" onblur="checkchangeWork()" style="width:65px"></td>
						
						
						 <td class="input" ><input name="changeThisWorkNum" value="<%=LwNewFactoryIndicatorDto2.getThisWorkNum()%>" onblur="checkchangeWork()"  style="width:65px"></td>
						
						<td class="input" ><input name="changeLastIdleNum" value="<%=LwNewFactoryIndicatorDto2.getChangeunWorkPointer()%>"  onblur="checkchangeunWork()" style="width:65px" ></td>
						
						
					
						 <td class="input" ><input name="changeThisIdleNum" value="<%=LwNewFactoryIndicatorDto2.getThisIdleNum()%>" onblur="checkchangeunWork()" style="width:65px"></td>
						...
						<td class="input" ><input name="changeRate" value="<%=LwNewFactoryIndicatorDto2.getRate()%>" style="width:65px" onblur="checkchangeRate()"></td>
						 ...
						 <td class="input" ><input name="changeworkQuantity" value="<%=LwNewFactoryIndicatorDto2.getChangeworkQuantity()%>" style="width:65px"></td>
						
						
						
						 <td class="input" ><input name="changeunworkQuantity" value="<%=LwNewFactoryIndicatorDto2.getChangeUnworkQuantity()%>" style="width:65px"></td>
       ...
       <tr >
        ...
        <td class="input" ><input name="changeday" value="<%=LwNewFactoryIndicatorDto2.getChangeday()%>"  style="width:65px"></td>
							
							
					
						 <td class="input" ><input name="changeChgAmmeterQuantity" value="<%=LwNewFactoryIndicatorDto2.getChageChgAmmeterQuantity()%>"   style="width:65px"></td>
						
						 <td class="input" ><input name="changeUnChgAmmeterQuantity" value="<%=LwNewFactoryIndicatorDto2.getChangeunChgAmmeterQuantity()%>"   style="width:65px"></td>
						
						 <td class="input" ><input name="changeCompensateQuantity" value="<%=LwNewFactoryIndicatorDto2.getChangeCompensateQuantity()%>" style="width:65px"></td>
						
	
						
						 <td class="input" ><input name="changeUnCompensateQuantity" value="<%=LwNewFactoryIndicatorDto2.getChangeunCompensateQuantity()%>" style="width:65px"></td>
