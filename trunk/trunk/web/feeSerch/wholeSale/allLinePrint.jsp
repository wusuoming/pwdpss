...
<form  name="fm" method="post">
	...
	<!--点击新增时显示的新增路径条件部分(公用)-->
		...
		<td class="input" align="center"><input   name="inputDate" value="<%=(String)request.getAttribute("inputDate") %>" style="border:0" readonly="readonly" style="width:65px"></td>
						<td class="input" align="center"><input   name="comcode" value="<%=(String)request.getAttribute("comcode") %>" style="border:0" readonly="readonly" style="width:65px"></td>
		</tr>
		<tr>
