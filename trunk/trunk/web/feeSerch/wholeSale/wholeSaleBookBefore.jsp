    ...
    <!--CONTENT BEGIN-->
	  ...
	  <td class="title" id="s">趸售公司：</td>	
         <td class="input" id="d"><select name="company" >
		  ...
		  <tr><td  colspan="4" align="center"><input class=button name="serch" type="button"  value="统计 " onClick="javascript:wholeSaleSerch();"></td>
...
if(fm.inputDate.value ==''){
   ...
   return false;
	...
	fm.action="/iacontact/UIWholeSaleBookSerchBefore.do";
