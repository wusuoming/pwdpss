...
<%@ page info = "GradeManageQuery.jsp -- 岗位 查询，李子扬，2006-08-24。" %>
...
<html:form action="/GradeManageList">
	<table class="common" border="0" cellspacing="1" cellpadding="5">
		<tr>
			<td class="title0" colspan="4"><B>岗位查询</B></td>
		</tr>
		<tr>
			<td class="title">岗位代码：</td>
			<td class="input"><input type="text" name="gradeCode" class="text" style="width:100%"></td>
			<td class="title">岗位名称：</td>
			<td class="input"><input type="text" name="gradeName" class="text" style="width:100%"></td>    
		</tr>
		<tr>
