 ...
 * 这是LWTownIndicatorBak-直供乡电表指针记录备份表的数据传输对象基类<br>
 */
public class LwTownIndicatorBakDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的LwTownIndicatorBakDtoBase对象
     */
    public LwTownIndicatorBakDtoBase(){
    }
    ...
    /**
     * 设置属性追收计算电量
     * @param appendCalQuantity 待设置的属性追收计算电量的值
     */
