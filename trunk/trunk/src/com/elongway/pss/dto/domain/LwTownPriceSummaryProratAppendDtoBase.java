 ...
 * 这是LWTownPriceSummaryProrateAppend-直供乡追加电费计算总表的数据传输对象基类<br>
 */
public class LwTownPriceSummaryProratAppendDtoBase implements Serializable{
    ...
    /**
     *  默认构造方法,构造一个默认的LwTownPriceSummaryProratAppendDtoBase对象
     */
    public LwTownPriceSummaryProratAppendDtoBase(){
    }
