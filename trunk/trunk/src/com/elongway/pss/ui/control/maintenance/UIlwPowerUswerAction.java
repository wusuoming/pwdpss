...
public class UIlwPowerUswerAction extends Action {
...
//		}
		...
		// 电表信息
		Collection ammeterList = blLwAmmeterChangeFacade.findByConditions("userNo = '"+userNo+"' and flag = '"+AppConst.CURRENT_AMMETER_FLAG+"'");
		if (ammeterList!=null) {
		...
		return actionMapping.findForward("lwPowerUser");
	}
