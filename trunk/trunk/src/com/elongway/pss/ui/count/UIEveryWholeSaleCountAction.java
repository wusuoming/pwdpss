...
public class UIEveryWholeSaleCountAction extends Action {
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection colall = blLwDcodeFacade
				.findByConditions(" CODETYPE='WholeSaleCom'");
		...
		while (itall.hasNext()) {
			...
			Collection colone = blLwWholeSaleSummaryFacade
					.findByConditions(" statMonth='" + statmonth
							+ "' and upCompany='" + lwDcodeDto.getCodeCode()
							+ "' and kv=10");
			Collection colone35 = blLwWholeSaleSummaryFacade
					.findByConditions(" statMonth='" + statmonth
							+ "' and upCompany='" + lwDcodeDto.getCodeCode()
							+ "' and kv=35");
			...
			while (itone.hasNext()) {
				...
				feijumindianliang += lwWholeSaleSummaryDto
				...
				if (lwWholeSaleSummaryDto.getWholesaletype().equals("1")) {
					gongyedianliang += lwWholeSaleSummaryDto
							.getElectricQuantity();
					gongyedianfee += lwWholeSaleSummaryDto.getSumFee()
							- lwWholeSaleSummaryDto.getPowerRateFee();
				}
				nongguandianliang += lwWholeSaleSummaryDto.getFarmUseQuantity();
				nongguandianfee += lwWholeSaleSummaryDto.getFarmUseFee();
				shengchandianliang += lwWholeSaleSummaryDto
						.getProductQuantity();
			...
			while (itone35.hasNext()) {
				...
				feijumindianliang35 += lwWholeSaleSummaryDto
						.getUnDenizenQuantity();
				...
				if (lwWholeSaleSummaryDto.getWholesaletype().equals("1")) {
					gongyedianliang35 += lwWholeSaleSummaryDto
							.getElectricQuantity();
					gongyedianfee35 += lwWholeSaleSummaryDto.getSumFee()
							- lwWholeSaleSummaryDto.getPowerRateFee();
				}
				nongguandianliang35 += lwWholeSaleSummaryDto
						.getFarmUseQuantity();
				nongguandianfee35 += lwWholeSaleSummaryDto.getFarmUseFee();
				shengchandianliang35 += lwWholeSaleSummaryDto
						.getProductQuantity();
			...
			if (lwWholeSaleSummaryDto.getUpCompany().equals("gy")
					|| lwWholeSaleSummaryDto.getUpCompany().equals("dm")) {
				sanxiafee = (wholeSaleFee.getJumindianliang()
						+ wholeSaleFee.getJumindianliang35()
						+ wholeSaleFee.getFeijumindianliang()
						+ wholeSaleFee.getFeijumindianliang35()
						+ wholeSaleFee.getShangyedianliang()
						+ wholeSaleFee.getShangyedianliang35()
						+ wholeSaleFee.getShengchandianliang()
						+ wholeSaleFee.getShengchandianliang35()
						+ wholeSaleFee.getGongyedianliang() + wholeSaleFee
						.getGongyedianliang35()) * 0.004 * 0.88 / 1.17;
				dianjinfee = (wholeSaleFee.getJumindianliang()
						+ wholeSaleFee.getJumindianliang35()
						+ wholeSaleFee.getFeijumindianliang()
						+ wholeSaleFee.getFeijumindianliang35()
						+ wholeSaleFee.getShangyedianliang()
						...
						+ wholeSaleFee.getShengchandianliang35()
						+ wholeSaleFee.getGongyedianliang() + wholeSaleFee
						.getGongyedianliang35()) * 0.02 * 0.88 / 1.17;
				jijinfee = (wholeSaleFee.getJumindianliang() + wholeSaleFee
						.getJumindianliang35())
						* 0.001
						* 0.88
						/ 1.17
						+ (wholeSaleFee.getFeijumindianliang()
								...
								+ wholeSaleFee.getShangyedianliang()
								+ wholeSaleFee.getShangyedianliang35()
								+ wholeSaleFee.getShengchandianliang() + wholeSaleFee
								.getShengchandianliang35())
						* 0.002
						* 0.88
						/ 1.17
						+ (wholeSaleFee.getJumindianliang()
								+ wholeSaleFee.getJumindianliang35()
								+ wholeSaleFee.getFeijumindianliang()
								+ wholeSaleFee.getFeijumindianliang35()
								+ wholeSaleFee.getShangyedianliang()
			...
			if (lwWholeSaleSummaryDto.getUpCompany().equals("jy")
					|| lwWholeSaleSummaryDto.getUpCompany().equals("ty")) {
				sanxiafee = (wholeSaleFee.getJumindianliang()
						+ wholeSaleFee.getJumindianliang35()
						+ wholeSaleFee.getFeijumindianliang()
						+ wholeSaleFee.getFeijumindianliang35()
						...
						+ wholeSaleFee.getShengchandianliang()
						+ wholeSaleFee.getShengchandianliang35()
						+ wholeSaleFee.getGongyedianliang()
						+ wholeSaleFee.getGongyedianliang35()
						+ wholeSaleFee.getNongguandianliang() + wholeSaleFee
						.getNongguandianliang35()) * 0.004 * 0.88 / 1.17;
				dianjinfee = (wholeSaleFee.getJumindianliang()
						+ wholeSaleFee.getJumindianliang35()
						+ wholeSaleFee.getFeijumindianliang()
						+ wholeSaleFee.getFeijumindianliang35()
		...
		httpServletRequest
				.setAttribute("allsanxiatax", df.format(allsanxiatax));
		...
		httpServletRequest.setAttribute("alldianjintax", df
				.format(alldianjintax));
		httpServletRequest.setAttribute("alldianfee", df
				.format(alldianfee / 1.17));

		httpServletRequest
				.setAttribute("alldianliang", df.format(alldianliang));
