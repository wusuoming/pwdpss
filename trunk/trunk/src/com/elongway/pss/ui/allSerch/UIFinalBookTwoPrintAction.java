...
public class UIFinalBookTwoPrintAction extends Action {
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {

		String linecode=httpServletRequest.getParameter("corporationName");
		String date=httpServletRequest.getParameter("inputDate");
		...
		while(it.hasNext()){ 
			...
			sumPower+=Double.parseDouble(lwWholeSaleIndicatorDto.getWorkQuantity());
		...
		if(colbak!=null){
			while(itbak.hasNext()){
				...
				sumPower+=Double.parseDouble(lwWholeSaleIndicatorBakDto.getWorkQuantity());
			}
		}
		...
		return actionMapping.findForward("viewbook");
}
